<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
	...
	List<VO> list = (List<VO>)request.getAttribute("list"); //사용자 정보를 담은 리스트를 받아오는 코드
%> 
                ...
                <div class="main_content1">
                    ...
                    <div class='wrap_donut'>
					  <div class='container_donut'>
					  	<p>검사수</p>
					    <div class="chart_donut doughnut1"><span class="center_donut"><%=tCount %>명</span></div>
					    <p>피싱 일치</p>
					    <div class="chart_donut doughnut2"><span class="center_donut"><%=fCount %>명</span></div>
					    <p>피싱 불일치</p>
					    <div class="chart_donut doughnut3"><span class="center_donut"><%=Integer.parseInt(tCount) - Integer.parseInt(fCount) %>명</span></div>
					  </div>
					...
					<script>
					   	...
					   	// 리셋 함수
					   	const replay = () => {
					   	  makeChart(<%=tCount %>, chart1, '#f5b914');
					   	  makeChart(<%=fCount %>, chart2, '#0A174E');
					   	  makeChart(<%=Integer.parseInt(tCount) - Integer.parseInt(fCount) %>, chart3, '#66d2ce');
					   	}
                ...
                <div class="main_content2">
                    <div>
                     ...
                     <table class="date_table_box">
                           ...
                           <tr>
                            <th>	
                               	<form class="date_list" method="post" action="dlist">
				                    <input type="date" name ="fdate" value="0000-00-00"> -
				                    <input type="date" name ="bdate" value="0000-00-00">
				                    <input type="submit" value="조회">
		                    	</form>    
		                    	
		                    </th>    
		                    <th>		             			
	                    		<a href="regMember">사용자 등록</a><br>
		                    	
		                    </th>       
		                    <th>
		                    	<a href="memberList">사용자 조회</a>
		                    </th>
                           </tr>
                           </thead>
                       </table>           
